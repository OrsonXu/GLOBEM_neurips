...
def calc_cv_oneloop(clf: DepressionDetectionClassifierBase, data_repo: DataRepo, random_seed_index: int,
    ...
    Args:
        ...
        n_splits (int, optional): number of split. Defaults to 5.
    ...
    while True: 
        repeat_time += 1
        cv = StratifiedGroupKFold(n_splits=min(20, pidnum_min),shuffle=True,random_state=42+random_seed_index+repeat_time*1000)
